...
export const CHANNELS = [
  ...
  { value: 'louder', icon: 'https://i.imgur.com/r4GIRLL.png' },
  { value: 'rock', icon: 'https://i.imgur.com/Ffj1Opg.png' },
  { value: 'techno', icon: 'https://i.imgur.com/omLkrpT.png' },
  { value: 'albumoftheday', icon: 'https://i.imgur.com/RZQbasU.gif' },
  { value: 'soundscapes', icon: 'https://i.imgur.com/TUtJ82Q.jpg' },
  { value: 'djs', icon: 'https://i.imgur.com/EQ7kMoE.jpg' },
  { value: 'soundxyz', icon: 'https://i.imgur.com/BbvrNR2.jpg' },
  { value: 'bangers', icon: 'https://i.imgur.com/URBvewb.png' },
  { value: 'spotify', icon: 'https://i.imgur.com/3Z8YjMT.jpg' },
  { value: 'coop-recs', icon: 'https://i.imgur.com/eecb7AP.gif' },
  { value: 'housemusic', icon: 'https://i.imgur.com/rt1dcOI.jpg' },
  {
    value: 'classical',
