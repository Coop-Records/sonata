...
ALTER TABLE "public"."channel_tips_activity_log" ALTER COLUMN "id" ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME "public"."channel_tip_log_id_seq"
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE ONLY "public"."channel_tips_activity_log"
    ADD CONSTRAINT "activity_log_pkey" PRIMARY KEY ("id");
...
GRANT ALL ON TABLE "public"."channel_tips_activity_log" TO "anon";
GRANT ALL ON TABLE "public"."channel_tips_activity_log" TO "authenticated";
GRANT ALL ON TABLE "public"."channel_tips_activity_log" TO "service_role";
...
GRANT ALL ON SEQUENCE "public"."channel_tip_log_id_seq" TO "anon";
GRANT ALL ON SEQUENCE "public"."channel_tip_log_id_seq" TO "authenticated";
GRANT ALL ON SEQUENCE "public"."channel_tip_log_id_seq" TO "service_role";
