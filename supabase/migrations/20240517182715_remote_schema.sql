...
ALTER TABLE "public"."stake_activity_log" ALTER COLUMN "id" ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME "public"."activity_log_id_seq"
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE ONLY "public"."stake_activity_log"
...
GRANT ALL ON TABLE "public"."stake_activity_log" TO "anon";
...
GRANT ALL ON SEQUENCE "public"."stake_activity_log_id_seq" TO "anon";
GRANT ALL ON SEQUENCE "public"."stake_activity_log_id_seq" TO "authenticated";
GRANT ALL ON SEQUENCE "public"."stake_activity_log_id_seq" TO "service_role";
