...
export default function ChannelFilter() {
  ...
  return (
    <div className="flex grow flex-col">
      <h2 className="mb-6 font-clashDisplay text-2xl font-medium">Channels</h2>
        ...
        {menuItems.map((option) => {
          ...
          return (
            <Link
              ...
              key={option.value}
              className={cn(
                'flex px-6 py-2 justify-start items-center gap-2 w-full font-semibold text-sm rounded-xl',
                active && 'bg-secondary',
              )}
            >
